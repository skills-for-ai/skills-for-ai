---
name: peak-testing-skill
description: Use when asked to test system behavior during predictable high-traffic periods (peak business hours, seasonal spikes) — as distinct from stress testing beyond normal capacity generally (see stress-testing-skill) or sudden unpredictable spikes specifically, which peak testing's predictable-timing focus differs from.
---
...
- [[stress-testing-skill]] for testing behavior beyond normal capacity generally, not tied to a predictable calendar event.
- [[load-testing-skill]] for the broader staged load-testing progression peak testing is a specific case within.
