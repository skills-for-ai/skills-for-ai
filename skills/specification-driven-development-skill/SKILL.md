---
name: specification-driven-development-skill
...
- [[test-driven-development-skill]] drives design from a failing test,
...
- [[behavior-driven-development-skill]] writes acceptance-level scenarios
...
- [[test-driven-development-skill]], [[behavior-driven-development-skill]] for the test-level and scenario-level disciplines that complement a written spec.
- [[architecture-decision-record-skill]], [[decision-records-skill]] for capturing the *reasoning behind* a specific spec decision, distinct from the spec's normative content itself.
