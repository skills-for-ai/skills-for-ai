...
methods elsewhere in this collection ([[bayes-theorem-analysis]],
[[chi-square-analysis]], [[monte-carlo-analysis]]) are each
...
- **Inferential statistics** — generalizes from a sample to a larger
  ...
  [[chi-square-analysis]] for that one specifically).
...
- **Time series analysis** — studies patterns, trends, and seasonality
  ...
  models (see [[trend-analysis]] for the applied version of this).
...
- **Cluster analysis** — groups observations by similarity: k-means,
  ...
  [[anomaly-analysis]]'s use of clustering specifically to flag
...
- **Ignoring a technique's underlying assumptions** — most of these
  ...
  [[chi-square-analysis]] notes for its own small-expected-
  frequency caveat, can silently invalidate the result.

## Learn more

- [[bayes-theorem-analysis]], [[chi-square-analysis]], [[monte-carlo-analysis]] for specific techniques within this family, covered in depth.
- [[trend-analysis]], [[anomaly-analysis]] for applied time-series and outlier-detection techniques.
- [[decision-tree]] for the data-mining technique also used as a general business decision-evaluation tool.
