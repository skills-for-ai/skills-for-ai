...
a browser-native alternative to [[plantuml-diagram-skill]]'s
...
territory as [[plantuml-diagram-skill]] (see
[[activity-diagram-skill]], [[sequence-diagram-skill]],
[[class-diagram-skill]], [[state-diagram-skill]] and this collection's
...
[[plantuml-diagram-skill]], which more commonly needs a rendering step or
...
PlantUML (see [[plantuml-diagram-skill]]) offers a broader diagram-type
...
- **Overly dense flowcharts** — Mermaid's approachable syntax makes it
  ...
  [[flowchart-skill]] and [[class-diagram-skill]] give elsewhere applies
  here too.
...
- [[plantuml-diagram-skill]] for the alternative text-based diagramming tool with a broader diagram-type catalog.
- [[flowchart-skill]], [[sequence-diagram-skill]], [[class-diagram-skill]], [[state-diagram-skill]] for the underlying diagram-type modeling concepts, independent of rendering tool.
