---
name: split-testing
description: Use when asked to compare two or more variations of a design/interface to see which performs better — the general step-by-step process (goal, variation, random allocation, data collection, analysis) shared with A/B testing (see a-b-testing), applied to UI/UX design decisions specifically.
---
...
goal — the same underlying method as [[a-b-testing]], commonly
...
converts better), while [[a-b-testing]] is often the term used in a
...
Shared directly with [[a-b-testing]]: stopping the test as soon as
...
- [[a-b-testing]] for the same underlying method in fuller depth.
- [[ui-ux-testing]] for the broader design-evaluation context split testing is commonly used within.
