---
name: load-testing-skill
description: Use when asked to test how an application performs under expected and peak user load — capacity limits, breaking points — as distinct from stress testing beyond normal capacity (see stress-testing-skill) or sudden-spike testing (see peak-testing-skill), which load testing's staged progression leads into.
---
...
- **Spike testing** — sudden, sharp load increases (closely related to
  [[peak-testing-skill]]'s sustained-peak-period focus).
...
before-the-fact-metric discipline [[a-b-testing-skill]] requires for its
...
- [[stress-testing-skill]] for load beyond normal capacity specifically.
- [[peak-testing-skill]] for sustained high-traffic-period testing.
- [[performance-testing-skill]] for the broader performance-verification discipline load testing is one technique within.
