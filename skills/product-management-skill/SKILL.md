...
from [[project-management-skill]], which owns the *how/when/who* of
...
- **Discovery** — figuring out what to build: user research (see
  [[user-centred-design-skill]]), validating a problem is real and worth
...
- [[project-management-skill]] for the delivery-execution discipline product management partners with.
- [[user-centred-design-skill]] for the research methods discovery depends on.
