---
name: failover-testing-skill
description: Use when asked to test automatic switchover to a backup component, server, or network on primary failure — as a specific slice of chaos testing (see chaos-testing-skill) and disaster recovery testing (see disaster-recovery-testing-skill) focused specifically on redundancy activation.
---

# Failover Testing Skill
...
objective (RPO)** are the key numbers (see [[disaster-recovery-testing-skill]]
...
- [[disaster-recovery-testing-skill]] for the broader recovery-procedure testing discipline this specializes.
- [[chaos-testing-skill]] for exploring failure modes beyond the specific redundancy-switchover case.
