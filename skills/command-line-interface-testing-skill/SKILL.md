---
name: command-line-interface-testing-skill
description: Use when asked to test a CLI tool — command syntax, exit codes, stdout/stderr validation, cross-platform behavior — as distinct from terminal UI testing (see terminal-user-interface-testing-skill), which covers interactive, layout-based terminal applications rather than single-invocation commands.
---

# Command Line Interface (CLI) Testing Skill
...
correctly across scenarios. See [[terminal-user-interface-testing-skill]]
...
- [[terminal-user-interface-testing-skill]] for interactive, screen-based terminal applications specifically.
- [[functional-testing-skill]] for the broader behavior-verification discipline CLI testing is an instance of.
