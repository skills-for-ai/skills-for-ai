---
name: kanban
description: Use when asked to set up or run a Kanban board — columns, work-in-progress limits, continuous flow — as an alternative to Scrum's fixed sprints (see scrum), suited to continuous-flow work rather than timeboxed iterations.
---
...
- **Continuous improvement** — regular review and retrospectives to
  ...
  [[kaizen]]'s continuous-improvement philosophy.

## Kanban vs. Scrum

Unlike [[scrum]]'s fixed-length sprints with a committed sprint
...
- **Forcing Kanban onto work that genuinely needs fixed-scope, timeboxed
  ...
  may fit [[scrum]]'s sprint structure better than Kanban's
  continuous flow.
