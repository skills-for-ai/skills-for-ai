---
name: agile-showcase
description: Use when asked to run an agile showcase (sprint review) — demonstrating working software to stakeholders on a regular cadence — including whether a team should run one at all, mirroring the same with/without tradeoff agile-standup covers for daily standups.
---
...
Like [[agile-standup]]'s standup question, showcases aren't
...
- **Letting the showcase run over its timebox** — same discipline as
  [[agile-standup]]'s timeboxing; a showcase that regularly runs
...
- [[agile-standup]] for the same with/without tradeoff applied to the daily standup.
- [[agile-reflection]] for the deeper process-improvement ceremony a showcase doesn't replace.
