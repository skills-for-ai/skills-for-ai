---
name: mutation-testing-skill
description: Use when asked to measure whether a test suite can actually detect faults — mutation score, killed vs. surviving mutants — as a more rigorous alternative to code coverage percentage, and a companion to test-driven development (see test-driven-development-skill).
---
...
genuinely pin down behavior — exactly the gap [[test-driven-development-skill]]'s
...
- [[test-driven-development-skill]] for the discipline mutation testing helps validate is actually being followed effectively.
- [[unit-testing-skill]], [[white-box-testing-skill]] for the layer mutation testing is most commonly applied at.
