---
name: total-project-control-skill
...
Critical Path Method (see [[critical-path-skill]]), and PERT (Program
...
- **Doubled Resource Estimated Duration (DRED)** — an estimate of how much
  ...
  is actually worth the cost (see "crashing" in [[critical-path-skill]]).
...
- [[critical-path-skill]] for the underlying CPM concepts (float, crashing) TPC extends.
- [[project-management-skill]] for the broader project-management context.
