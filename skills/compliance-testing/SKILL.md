...
description: Use when asked to test whether software adheres to regulatory or policy standards (HIPAA, PCI-DSS, GDPR, SOX) — as distinct from security testing broadly (see security-testing), which compliance testing draws on but is scoped specifically to named external requirements.
---
...
- [[security-testing]] for the broader security-verification discipline compliance testing draws specific, regulation-scoped checks from.
- [[information-manager]] for the organizational information-governance function compliance testing supports.
