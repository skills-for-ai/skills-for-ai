---
name: trend-analysis
description: Use when asked to analyze data over time to identify patterns and forecast — regression, moving averages, exponential smoothing — as distinct from anomaly-analysis's focus on individual deviant points rather than the overall directional pattern.
---
...
Trend analysis and [[anomaly-analysis]] examine the same
...
- **Confusing correlation over time with causation** — two trending
  ...
  see [[chi-square-analysis]] and [[statistical-analysis]]
...
- [[anomaly-analysis]] for the complementary individual-deviation analysis.
- [[statistical-analysis]] for the broader statistical toolkit (including regression and time-series methods) trend analysis draws on.
- [[key-performance-indicators]] for the metrics trend analysis is often applied to track over time.
