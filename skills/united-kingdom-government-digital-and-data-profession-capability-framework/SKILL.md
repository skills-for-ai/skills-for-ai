---
name: united-kingdom-government-digital-and-data-profession-capability-framework
...
repository's content, use `uk-gdad-maintainer` instead.
...
| Competency assessment, by assessor | `/competency-assessments-by-assessor/<slug>/` | A skill-by matrix an assessor rates a candidate or employee against, 0–4 |
