...
[[fuzz-testing]] hunts for specific crashing or vulnerable inputs
...
- [[fuzz-testing]] for the related but goal-distinct randomized-input technique focused on finding specific crashing inputs.
- [[performance-testing]] for a common application domain (reliability/performance under varied simulated conditions).
