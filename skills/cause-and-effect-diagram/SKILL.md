...
description: Use when asked to run a root-cause analysis session using a fishbone/Ishikawa-style diagram — the 6M cause categories (Manpower, Methods, Machines, Materials, Measurements, Mother Nature) — the same technique also called fishbone-diagram or ishikawa-diagram under alternate names.
---
...
[[fishbone-diagram]] and [[ishikawa-diagram]] for the
...
Brainstorm possible causes of the problem (see [[brainstorming]]
...
- [[fishbone-diagram]], [[ishikawa-diagram]] — the same technique under its other common names.
- [[brainstorming]] for running the cause-generation step well.
- [[dmaic]] for the broader Six Sigma methodology this technique is commonly used within (typically during the Analyze stage).
