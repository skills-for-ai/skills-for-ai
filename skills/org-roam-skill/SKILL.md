---
name: org-roam-skill
description: Use when asked to build a networked "second brain" of notes in Emacs using org-roam — bidirectional linking, the node/backlink model, and the daily-notes workflow — as an Org mode extension (see org-mode-skill), distinct from org-contacts' single-purpose contact list (see org-contacts-skill).
---
...
folder hierarchy. See [[org-mode-skill]] for the underlying Org syntax
...
- **Confusing org-roam with org-contacts** — org-roam is a general
  networked-notes tool; [[org-contacts-skill]] is a narrower,
...
- [[org-mode-skill]] for the underlying Org syntax org-roam extends.
- [[org-contacts-skill]] for a narrower, single-purpose Org extension by contrast.
