...
description: Use when asked to apply Domain-Driven Design (DDD) — ubiquitous language, bounded contexts, entities/value objects, aggregates, domain events — as a software-design approach for aligning code structure with business domain concepts, complementing class-diagram-skill's structural notation and package-diagram-skill's module organization.
---
...
A [[class-diagram-skill]] can express DDD's entities, value objects, and
their relationships in UML notation; a [[package-diagram-skill]] can
...
- [[class-diagram-skill]] for notating entities, value objects, and their relationships.
- [[package-diagram-skill]] for notating bounded-context boundaries.
