...
from the same task network as the [[critical-path-skill]]'s Critical Path
...
- [[critical-path-skill]] for the underlying unconstrained-resource scheduling method CCPM builds on and diverges from.
- [[project-management-skill]] for the broader scheduling/risk context.
