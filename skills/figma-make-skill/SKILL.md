...
a separate product from core Figma design ([[figma-skill]]), though it
integrates with it.
...
- **MCP connectors** — Model Context Protocol integrations let Make pull
  ...
  [[claude-ai-skill]] for what MCP is, independent of Figma).
...
- [[figma-skill]] for Figma's core design tool.
