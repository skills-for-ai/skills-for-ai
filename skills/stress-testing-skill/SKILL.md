...
description: Use when asked to test a system under extreme conditions beyond its normal capacity — finding the breaking point and recovery behavior — as one specific variant within performance testing broadly (see performance-testing-skill), distinct from load testing at expected capacity (see load-testing-skill).
---
...
- **Confusing stress testing with load testing** — load testing validates
  behavior at expected/peak capacity ([[load-testing-skill]]); stress
...
- [[load-testing-skill]] for testing at expected/peak capacity, distinct from stress testing's beyond-capacity focus.
- [[performance-testing-skill]] for the broader umbrella discipline stress testing is one variant within.
