---
name: bayes-theorem-analysis-skill
description: Use when asked to apply Bayes' theorem — updating a probability estimate given new evidence, P(A|B) = P(B|A)·P(A)/P(B) — as one specific probabilistic technique within the broader statistical-analysis toolkit (see statistical-analysis-skill), foundational to Bayesian inference and Bayesian networks.
---

# Bayes' Theorem Analysis Skill
...
- [[statistical-analysis-skill]] for the broader technique family Bayes' theorem is one specific tool within.
- [[chi-square-analysis-skill]] for a different technique testing association between categorical variables, useful to contrast against Bayesian updating's different underlying question.
