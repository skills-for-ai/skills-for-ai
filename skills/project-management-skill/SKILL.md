...
concepts common across methodologies; [[agile-principles-skill]] covers the
...
- **RAID log** (Risks, Assumptions, Issues, Dependencies) — a single running
  ...
  than signal.
- **Status update** — see [[ways-of-working-skill]] for the general
...
- **Agile** (Scrum, Kanban, XP, …) — iterative delivery of working
  increments, welcoming change even late (see [[agile-principles-skill]]).
...
- [[agile-principles-skill]] — the reasoning behind iterative delivery specifically.
- [[ways-of-working-skill]] — communication and team-operating norms that apply directly to running a project.
