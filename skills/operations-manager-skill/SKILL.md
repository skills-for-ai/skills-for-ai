...
[[project-management-skill]]'s bounded, one-time work. Operations is what
...
- **Bottleneck identification** — in any multi-step process, the slowest
  ...
  throughput, the same underlying idea [[critical-path-skill]] applies to
  project schedules.
...
- [[critical-path-skill]] for the bottleneck/dependency logic operations shares with project scheduling.
- [[project-management-skill]] for the bounded-work counterpart to ongoing operations.
