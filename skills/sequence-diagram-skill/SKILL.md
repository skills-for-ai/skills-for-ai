...
[[class-diagram-skill]]) can't show.

## Drawing one

See [[plantuml-diagram-skill]] for the `@startuml` sequence-diagram syntax
...
- [[use-case-diagram-skill]] for the complementary, user-perspective functionality view.
- [[class-diagram-skill]] for the static structure underlying the objects a sequence diagram shows interacting.
