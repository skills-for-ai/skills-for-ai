---
name: pair-programming-skill
description: Use when asked to set up or run pair programming — driver/navigator roles, in-person and remote setups — as a real-time collaborative alternative to solo development plus asynchronous code review, and a common practice alongside test-driven-development-skill.
---
...
Pair programming and [[test-driven-development-skill]] are commonly
...
- [[test-driven-development-skill]] for the closely related practice pair programming often accompanies.
- [[agile-coaching-skill]] for helping a team decide when and how to adopt pairing.
