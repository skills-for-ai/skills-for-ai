...
design-tool counterpart to CSS Flexbox (see [[css-skill]]). Getting auto
...
[[figma-make-skill]]'s territory — Dev Mode is about accurate handoff and
...
- [[figma-make-skill]] for Figma's separate AI prototype/app-generation product.
