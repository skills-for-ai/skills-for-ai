---
name: critical-to-quality-skill
description: Use when asked to define Critical to Quality (CTQ) requirements in a Six Sigma context — translating customer expectations into measurable product/service characteristics with performance targets — as distinct from the general SQA catalog (see system-quality-attributes-skill) and feeding directly into a dmaic-skill project's Define/Measure stages.
---

# Critical to Quality (CTQ) Skill
...
[[voice-of-the-customer-skill]] for the customer-feedback side of this
...
CTQ identification typically happens during a [[dmaic-skill]] project's
**Define** stage (what does the customer actually need) and is tracked
through **Measure** and **Control**. CTQs are narrower and more
customer-facing than [[system-quality-attributes-skill]]'s full catalog
...
- **CTQs defined from internal assumption rather than real customer
  ...
  [[voice-of-the-customer-skill]] for grounding CTQs in actual feedback.
...
- **Too many CTQs diluting focus** — similar to
  [[critical-success-factors-skill]]'s warning about too many CSFs; CTQs
...
- [[dmaic-skill]] for the broader Six Sigma methodology CTQ identification fits within.
- [[voice-of-the-customer-skill]] for grounding CTQs in real customer feedback.
- [[system-quality-attributes-skill]] for the broader, more technical quality-attribute catalog CTQs are a customer-focused subset of.
