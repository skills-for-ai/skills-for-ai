---
name: decision-tree-skill
description: Use when asked to build a decision tree — a branching structure of decisions and their outcomes, for classification, prediction, or evaluating scenarios — as one structured evaluation tool, distinct from the generative, judgment-free phase of ideation (see ideation-skill) that typically precedes it.
---
...
[[ideation-skill]]'s judgment-free idea generation has produced the
...
- **Building a decision tree before the option space is actually
  explored** — see [[ideation-skill]]; a tree built from a narrow,
...
- [[ideation-skill]] for the generative phase that typically precedes decision-tree evaluation.
- [[plantuml-diagram-skill]] for text-based diagramming (including tree-like structures) if a version-controlled representation is preferred.
