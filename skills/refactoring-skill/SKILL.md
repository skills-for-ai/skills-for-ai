...
description: Use when asked to improve existing code's internal structure without changing its external behavior — rename, extract, replace conditionals with polymorphism, and other restructuring techniques — as a continuous discipline for managing technical debt, closely paired with test-driven-development-skill.
---
...
unchanged. This is why refactoring and [[test-driven-development-skill]]
...
- [[test-driven-development-skill]] for the testing discipline that makes refactoring safe.
- [[pair-programming-skill]] for a practice that often surfaces refactoring opportunities in real time.
