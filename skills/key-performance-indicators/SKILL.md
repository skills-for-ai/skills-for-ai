...
- **Objective** — its clear relationship to an organizational objective
  (see [[objectives-and-key-results]]).
...
strategic OKR? Does it support setting [[smart-criteria]]-compliant
...
- [[objectives-and-key-results]] for connecting a KPI to a strategic objective.
- [[smart-criteria]] for the goal-quality criteria a good KPI should support.
- [[strategic-balanced-scorecard]] for a planning framework built directly on OKRs + KPIs + CSFs together.
