---
name: system-quality-attributes-skill
...
# System Quality Attributes Skill
...
- **Key Performance Indicator (KPI)** — see [[key-performance-indicators-skill]]
...
- **System Quality Attributes Maturity Model (SQAMM)** — applying
  [[maturity-models-skill]]'s level-based structure specifically to
...
- [[key-performance-indicators-skill]] for turning a chosen attribute into a tracked metric.
- [[maturity-models-skill]] for assessing quality-attribute capability over levels.
