---
name: decision-record-testing-skill
description: Use when asked to verify that a codebase actually reflects a recorded architectural decision (an ADR/DR) — reviewing a decision record for testability, or checking code/CI for drift from a decision already made — as distinct from writing the decision record itself (see architecture-decision-record-skill, decision-records-skill).
---

# Decision Record Testing Skill
...
enforced, checkable fact). See [[architecture-decision-record-skill]] and
[[decision-records-skill]] for writing the records themselves; this skill
...
[[specification-driven-development-skill]] applies to writing any spec.
...
- **Static checks / linters** — a rule forbidding a specific import,
  ...
  one).
- **Architecture fitness functions** — see [[fitness-function-testing-skill]]
...
- [[architecture-decision-record-skill]], [[decision-records-skill]] for writing the decision record itself.
- [[fitness-function-testing-skill]] for the broader discipline of continuously checking architecture against intent.
- [[specification-driven-development-skill]] for the general principle of keeping written intent and actual behavior reconciled.
