---
name: information-manager-skill
...
[[postgresql-database-skill]]) or a security-tooling skill covers.
...
- **Retention schedule** — a policy stating how long each category of
  ...
  (see [[locale-skill]]'s note on jurisdiction-specific data-protection
...
- **Applying one jurisdiction's data-protection assumptions globally** —
  ...
  jurisdiction (see [[locale-skill]] on not assuming rules generalize) and
...
- [[locale-skill]] for why data-protection/retention rules vary by jurisdiction and shouldn't be assumed universal.
