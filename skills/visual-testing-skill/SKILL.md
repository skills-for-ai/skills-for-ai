...
description: Use when asked to catch unintended UI appearance changes — screenshot-baseline comparison, pixel/DOM/AI-based diffing — as distinct from functional testing (see functional-testing-skill), which validates behavior rather than appearance, and complementary to it.
---
...
can hide broken business logic that only [[functional-testing-skill]]
...
- [[functional-testing-skill]] for the complementary behavior-verification discipline.
- [[accessibility-testing-skill]] for another visual-adjacent but distinct quality dimension (perceivability for assistive technology, not just sighted appearance).
