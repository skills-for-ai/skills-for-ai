...
description: Use when asked to measure application responsiveness and resource use under workload — the umbrella covering load, stress, endurance, and spike testing (see load-testing-skill, stress-testing-skill) — to identify bottlenecks and confirm the system meets performance requirements.
---
...
- **Load testing** — performance under normal and peak loads, simulating
  ...
  resource utilization (see [[load-testing-skill]] in depth).
- **Stress testing** — behavior under extreme loads beyond capacity,
  ...
  fails (see [[stress-testing-skill]]).
...
- [[load-testing-skill]], [[stress-testing-skill]], [[peak-testing-skill]] for the specific variants in depth.
- [[benchmark-testing-skill]] for comparing performance-testing results against a reference point.
- [[system-quality-attributes-skill]] for where "performance" sits among the fuller catalog of quality attributes.
