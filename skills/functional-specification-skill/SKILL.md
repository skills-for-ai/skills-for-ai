---
name: functional-specification-skill
description: Use when asked to write a functional specification — user interface descriptions, inputs/outputs, technical details, error handling — as the detailed requirements document a project-scope-skill's requirements section points to, and the source of truth acceptance-testing-skill checks delivered software against.
---
...
detailed elaboration of what [[project-scope-skill]]'s "requirements"
section only names at a summary level.

## What it typically includes

- **User interface descriptions** — often via user stories, use cases
  (see [[use-case-diagram-skill]]), mockups, or wireframes, giving a
...
[[mental-model-skill]]) of what's actually being built. It also serves as
the basis for quality assurance and [[acceptance-testing-skill]] — a
...
- **Left stale as requirements evolve** — a functional spec that isn't
  ...
  truth it's meant to be (see [[specification-driven-development-skill]]'s
  identical discipline of keeping a spec and reality reconciled).

## Learn more

- [[project-scope-skill]] for the higher-level requirements summary a functional spec elaborates.
- [[acceptance-testing-skill]] for verifying delivered software against the functional spec.
- [[specification-driven-development-skill]] for the broader discipline of treating a written spec as the source of truth.
- [[use-case-diagram-skill]] for a common way to document user-interaction scenarios within a functional spec.
