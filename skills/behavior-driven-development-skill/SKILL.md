---
name: behavior-driven-development-skill
...
Behavior-Driven Development (BDD) extends [[test-driven-development-skill]]
...
- **Using BDD tooling for pure unit-level tests** where plain
  [[test-driven-development-skill]]-style tests would be clearer and less
...
- [[test-driven-development-skill]] for the underlying red/green/refactor discipline BDD builds on.
- [[specification-driven-development-skill]] for writing the specification as the primary artifact more generally.
